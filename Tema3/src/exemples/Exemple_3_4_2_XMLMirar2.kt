...
fun main(args: Array<String>) {
	...
	println(fills.item(0).getNodeName())   // el primer fill és el retorn de carro.
	println(fills.item(1).getNodeName())   // el segon fill sí que és vehiculo
	println(fills.item(2).getNodeName())   // el tercer fill és el retorn de carro.
	println(fills.item(3).getNodeName())   // el quart fill sí que és vehiculo
	println(fills.item(4).getNodeName())   // el cinquè fill és el retorn de carro.
